    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "פור אבר הפקות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3fb67e6d-8e5c-40e8-a2c3-f12de9c3c107',
                    name: data.name || '',
                    email: data.email || '',
